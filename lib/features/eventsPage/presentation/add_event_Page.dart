...
//         //   print(list_uploaded_link);}
//         if (state is AddNewEventSuccess) _showAwesomeDialog(context);
//       },
...
//                                     }
//
//                                     int firstMinutes = firstTime!.hour * 60 +
//                                         firstTime!.minute;
//                                     int secondMinutes = secondTime!.hour * 60 +
//                                         secondTime!.minute;
//
//                                     if (firstMinutes >= secondMinutes) {
//                                       return "enter_Correct_value"
//                                           .tr(); // Return validation message instead of printing
//                                     }
//
...
//                                       onChanged: (value) {
//                                         if (value != null &&
//                                             !participateTeams.contains(value) &&
//                                             participateTeams.length <= 1) {
...
//                               is_match
//                                   ? Container(
//                                       height: participateTeams.isEmpty ? 0 : 40,
//                                       // color: Colors.amber,
//                                       child: Expanded(
//                                         child: ListView.builder(
//                                           scrollDirection: Axis.horizontal,
//                                           itemCount: participateTeams.length,
//                                           itemBuilder: (context, index) {
//                                             final team =
...
//                                 onChanged: (value) {
//                                   if (value != null &&
//                                       !eventParticipate.contains(value)) {
//                                     setState(() {
...
//                                   itemBuilder: (context, index) {
//                                     final player = eventParticipate[index];
//                                     return Container(
...
//                                           SizedBox(width: 5),
//                                           ConstrainedBox(
//                                             // استخدام ConstrainedBox لتجنب overflow
//                                             constraints: BoxConstraints(
//                                                 maxWidth: 80), // ضبط عرض النص
//                                             child: Text(
//                                               player.displayName,
//                                               maxLines: 1,
...
//                                     for (int i = 0;
//                                         i < list_uploaded_link.length;
//                                         i++) {
//                                       listApplicationFiles.add(
//                                         InternalEventFile(
//                                             internalEventId: 0,
//                                             file: list_uploaded_link[i]),
//                                       );
//                                     }
//                                     //  print(listApplicationFiles[0].file);
//
//                                     print(eventParticipate[0].city);
//                                     print(eventParticipate[0].displayName);
//
//                                     print(eventParticipate[0].id);
//
//                                     // print(participateTeams[0].id);
//                                     // print(participateTeams[1].id);
//                                     print(_eventName.text);
//                                     for (var model in listApplicationFiles) {
...
//                                       //     .addNewMatchEvent(
//                                       //         eventType: 0,
//                                       //         startDate_Time: date_timeFrom(),
//                                       //         endDate_Time: date_timeTo(),
//                                       //         description:
//                                       //             _eventDescription.text,
//                                       //         eventName: _eventName.text,
//                                       //         location: _eventLocatioin.text,
//                                       //         firstTeamId:
...
//             " من: ${firstTime!.format(context)}      الي: ${secondTime!.format(context)}";
//       }
//     }
//   }
//
...
//   }
//
//   Widget _buildPlayerDetails(PlayerModel player, int index) {
//     return Container(
//       height: 40,
//       decoration: BoxDecoration(
//         color: Colors.white,
...
class _Add_eventState extends State<Add_event> {
  ...
  final CustomDropdownController_teams dropdownControllerTeams = CustomDropdownController_teams();
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color: is_match ? Color(0xffF0F6F4) : Colors.white,
                                          borderRadius: BorderRadius.circular(16),
                                          border: Border.all(
                                            color: is_match ? Color(0xff488B71) : Colors.white,
                                            width: 1,
                                          ),
                                        ),
                                        padding: EdgeInsets.all(5),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 5),
                                            Text("match".tr(), style: TextStyle(fontSize: 16)),
                                          ],
                                        ),
                                      ),
                                    ),
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          color: !is_match && !is_other ? Color(0xffF0F6F4) : Colors.white,
                                          borderRadius: BorderRadius.circular(16),
                                          border: Border.all(
                                            color: !is_match && !is_other ? Color(0xff488B71) : Colors.white,
                                            width: 1,
                                          ),
                                        ),
                                        padding: EdgeInsets.all(5),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 5),
                                            Text("training".tr(), style: TextStyle(fontSize: 16)),
                                          ],
                                        ),
                                      ),
                                    ),
                                ...
                                fillColor:Colors.white,
                                  ...
                                  items: [
                                    DropdownMenuItem(
                                      value: 0,
                                      child: Text("team".tr(),style: TextStyle(color: Colors.grey),),
                                    ),
                                    DropdownMenuItem(
                                      value: 1,
                                      child: Text("national team".tr(),style: TextStyle(color: Colors.grey),),
                                    ),
                                  ],
                                ),
                                SizedBox(
                                ...
                                is_match
                                    ? Container(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount: participateTeams.length,
                                          itemBuilder: (context, index) {
                                            final team = participateTeams[index];
                                            return _buildTeamDetails(team, index);
                                          },
                                        ),
                                      )
                                    : Container(),
                                ...
                                CustomDropdownButton_players(
                                  ...
                                  hint: 'participate'.tr(),
                                  onChanged: (value) {
                                    if (value != null && !eventParticipate.contains(value)) {
                                      setState(() {
                                        eventParticipate.add(value);
                                      });
                                    }
                                ...
                                GestureDetector(
                                  onTap: (state is AddNewEventLoading)?null:() async {
                                    if (formKey.currentState!.validate()) {
                                      List<ApplicationUserInternalEvent>
                                          listApplicationPlayers = [];
                                      for (int i = 0;
                                        ...
                                        BlocProvider.of<managerCubit>(context)
                                            .addNewMatchEvent(
                                                ...
                                                listApplicationPlayers:
                                                    listApplicationPlayers,
                                                listApplicationLink:
                                                    listApplicationFilesTest, teamType:  selectedValue ?? 0,);
                                      } else if (is_other) {
