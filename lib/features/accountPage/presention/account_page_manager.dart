              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: (){
                                          navigateTo(context, Editeaccountpage());
                                        },
                                        child: Text(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                     ...
                                     CacheHelper.getData(key: "UserName")??"name",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                    ...
                    if (roles == "Admin")                GestureDetector(
                      onTap: () {
                      ...
                      child: AccountItemWidget(
                        ...
                        backgroundColor: Color(0xff7047EB).withOpacity(.1),),
                    ),
                    if (roles == "Admin")       GestureDetector(
                      onTap: () {

                        navigateTo(context,  AudienceExperienceSchedule());
                      },
                      child: AccountItemWidget(
                          text: "expriencesTime".tr(),
                          iconPath: "assets/images/exp.jpeg",
                        backgroundColor: Color(0xff2BA170).withOpacity(.1),),
                    ),
                    GestureDetector(
                      onTap: () {
                      ...
                      child: AccountItemWidget(
                        ...
                        backgroundColor: Color(0xffF2994A).withOpacity(.1),),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: AccountItemWidget(
                        ...
                        backgroundColor: Color(0xffcccccc).withOpacity(.1),),
                    ),
                    if (roles == "Player" || roles == "Trainer")
                      GestureDetector(
                        child: AccountItemWidget(
                            ...
                            iconPath: "assets/images/44.png",
                          backgroundColor: Color(0xffF294A).withOpacity(.01),),
                      ),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              CacheHelper.clearSharedPreferencesExcept("FCMToken");
                            },
                            child: Text(
                              'Sign out'.tr(),
                              style: TextStyle(
